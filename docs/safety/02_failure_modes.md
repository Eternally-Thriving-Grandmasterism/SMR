...
**Revision:** 2026-07-26 (deepened rows; still design-time only)
...
|----|------|-----------------|------------------|-------------------|-------------------------|--------------------|
| FM-01 | Loss of forced flow | Core / primary heat-up | Flow, ΔT, inventory proxies | Geometry + natural circulation bias; passive priority over forced | TH benchmarks, friction maps | Order, Compassion |
| FM-02 | Reactivity insertion (concept) | Power excursion → fuel/temp challenge | Flux / period / reactivity proxies | Inherent feedback preference + documented passive shutdown path (see 01) | Kinetics refs, Doppler/moderator notes | Truth, Compassion |
...
| FM-06 | Loss of offsite power (LOOP) | Coincident loss of active support | Grid / bus status | Passive path must not require continuous offsite power | Station blackout concept note | Order, Compassion |
...
FM-01, FM-02, FM-06 are explicitly expected to terminate in the **passive shutdown path** documented under [`01_passive_shutdown.md`](01_passive_shutdown.md). If that note cannot absorb a mode, either deepen 01 or lower Compassion / Order scores on the proposal and re-export the open-data package.
